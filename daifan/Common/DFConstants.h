...
#define DEFAULT_BAR_HEIGHT 44.0f
#define DEFAULT_BUTTON_WIDTH 44.0f
#define DEFAULT_BUTTON_HEIGHT 44.0f
#define DEFAULT_IMAGE_WIDTH 40.0f
#define DEFAULT_IMAGE_HEIGHT 40.0f
